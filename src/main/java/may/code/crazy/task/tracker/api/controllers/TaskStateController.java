...
public class TaskStateController {
    ...
    public static final String CHANGE_TASK_STATE_POSITION = "/api/projects/{project_id}/position/change";
    public static final String DELETE_TASK_STATE = "/api/task-states/{task_state_id}";

    @GetMapping(GET_TASK_STATES)
    public List<TaskStateDto> getTaskState(
    ...
    public TaskStateDto createTaskState(
        ...
        optionalAnotherTaskState
                .ifPresent(anotherTaskState -> {
                    ...
                    anotherTaskState.setLeftTaskState(taskState);
